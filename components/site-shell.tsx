                ...
                {!step ? (
                  ...
                  <form className="checkout-form" onSubmit={checkout}>
                    ...
                    <p className="muted small">
                      Your order is confirmed only when the restaurant replies.
                      Enter an address for delivery; timing and charges are
                      agreed on WhatsApp.
                    </p>
                    ...
                    {sent && (
                      <p role="status" className="success-note">
                        ...
                        and wait for the restaurant’s confirmation. Your cart is
                        saved.
                      </p>
                    )}
                  </form>
